...
var processEvent = function(streamEvent, user, repos){
	var whitelist = ['testuser', 'm', 'ed', 'edf', 'fbtest', 'martin', 'chris1self', 'chriscobb', 'scottmuc', 'anildigital', 'chinmay185', 'rpowis'];
...
var createDailyInsightCards = function(user, repos, date){
	...
	var createDatabaseQuery = function(){
		var condition = {
			userId: user._id,
			date: date,
			objectTags: {$nin: ["twitter", "foursquare", "hackernews", "stackover"]}
		};
